...
public class MainController {
    ...
    public void onApplicationSelect(MouseEvent mouseEvent) {
    }

    public void onValueSelect(MouseEvent mouseEvent) {
    }
    @FXML
        ...
        public void Create(ActionEvent actionEvent)throws IOException {
          ...
          public void action(String word,List<Map<Character,Integer>> possibilities,ArrayList<String> final_content, int num_correct_letters,
                             HashMap<Integer, String> current_word ) throws  InvalidPosition, InvalidCharacter {
              ...
              if(parseInt(players_position) > word.length()){
                  Alert a1 = new Alert(AlertType.INFORMATION);
                  a1.setHeaderText("Please Insert a valid position number");
                  a1.showAndWait();
              ...
              if(!Character.isUpperCase(players_letter.charAt(0))){
                  Alert a1 = new Alert(AlertType.INFORMATION);
                  a1.setHeaderText("Please provide an uppercase character");
                  a1.showAndWait();
    ...
    public void Start() throws IOException, InvalidPosition {

        position.setText("");
        total_games_played +=1;
        total_games.setText(String.valueOf(total_games_played));
        percentage_xml.setText("0");
        correct = 0;
        total = 0;
        points = 0;
        ...
        for (int i = 0; i < content.size(); i++) {
            ...
            for(int i = 0; i < possibilities_round.size(); i++){
                ...
                btn1.setOnAction(e -> {
                    try {
                        action(word,possibilities,final_content,num_correct_letters, current_word);
                    } catch ( InvalidPosition | InvalidCharacter ex) {
                        ex.printStackTrace();
                    }
                });
    ...
    public void idCreate(MouseEvent mouseEvent) throws InvalidRangeExeception, UndersizeException, UnbalancedException, NoDescriptionExeception {
    ...
    public void IDSearch(MouseEvent mouseEvent) throws IOException{
        try {
            ...
            String res3 = ".txt";
            content = Files.readAllLines(Paths.get("./medialab/hangman_DICTIONARΥ-"+IDtosearch+res3));
    ...
    public void DictionaryStatistics(ActionEvent actionEvent) throws IOException {
    ...
    public void Solution() throws InvalidPosition, IOException {
